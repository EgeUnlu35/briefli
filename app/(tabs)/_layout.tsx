...
export default function TabLayout() {
  ...
  // Tab bar occupies: its height + bottom offset + safe area bottom inset
  const scenePaddingBottom = TAB_BAR_HEIGHT + TAB_BAR_BOTTOM + insets.bottom + 8;
